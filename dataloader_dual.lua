...
--        nSamples = self.testSamples
    ...
    local job_done = 0
    local idx = 1
    local frame_batch_CPU, frame_batch_map_CPU
    ...
    --                        local compmap = genSepPAFMap(aug_annos, compoNames, j_radius, aug_frame, model_output_scale)
                    ...
                    collectgarbage()
                    collectgarbage()
                    return frame_batch, frame_batch_map
                end,
                function(frame_batch, frame_batch_map)
    ...
    local function loop()
        ...
        enqueue()
        return job_done, frame_batch_CPU, frame_batch_map_CPU
    end
